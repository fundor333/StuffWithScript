...
from sqlalchemy import Column, Integer, String, \
    Text, DateTime, Unicode  # importing Unicode is important! If not, you likely encounter data type error.
...
class TWEET(Base):
    ...
    def __init__(self, query, user_type, tweet_id, inserted_date, truncated, language, possibly_sensitive, coordinates,
                 retweeted_status, withheld_in_countries, withheld_scope, created_at_text, created_at, month, year,
                 content,
                 ...
                 from_user_location, from_user_created_at, retweet_count, favorite_count, entities_urls,
                 entities_urls_count,
...
def get_data(kid):
    try:
        ...
        d = t.get_user_timeline(screen_name=kid, count="1", page="1", include_entities="true",
                                include_rts="1")  # NEW LINE
    ...
    for entry in d:
        ...
        if not updates:
            ...
            upd = TWEET(query, user_type, tweet_id, inserted_date, truncated, language, possibly_sensitive,
                        ...
                        created_at, month, year, content, from_user_screen_name, from_user_id,
                        from_user_followers_count,
                        from_user_friends_count, from_user_listed_count, from_user_favourites_count,
...
class Scrape:
    def __init__(self):
        engine = sqlalchemy.create_engine("sqlite:///", echo=False)  # enter your file path here.
