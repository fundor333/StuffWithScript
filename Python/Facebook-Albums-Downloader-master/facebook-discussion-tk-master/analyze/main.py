...
def main():
    ...
    parser.add_argument('--user', dest='facebook_username', required=True,
                        help='the email that you login to facebook with')
    parser.add_argument('--pass', dest='facebook_password', required=True,
                        help='the password that you login to facebook with')
